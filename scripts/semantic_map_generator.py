...
def parser_arguments():
    ...
    parser.add_argument("--src_path", type=str, default="/home/gzz/机械硬盘/sda3/woodscape/instance_annotations",
                        help="instance annotations directory")
    parser.add_argument("--dst_path", type=str, default="/home/gzz/机械硬盘/sda3/woodscape/semantic_annotations",
                        help="semantic annotations directory")
    parser.add_argument("--semantic_class_mapping", type=str, default="configs/semantic_mapping_3_classes.json",
                        help="semantic_mapping_x_classes.json")
    parser.add_argument("--instance_class_mapping", type=str, default="mappers/class_names.json",
